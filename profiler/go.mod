module github.com/eunomia-bpf/xpu-perf
...
require (
	...
	go.opentelemetry.io/ebpf-profiler v0.0.0-20250101000000-000000000000
...
// Use the local checkout or a specific version/commit
// For production, pin to a specific git tag or commit hash
